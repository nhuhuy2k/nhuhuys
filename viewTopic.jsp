<%-- 
    Document   : viewTopic
    Created on : 17-May-2020, 22:13:57
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center">
                    ...
                    <form class="ml-auto search-form d-none d-md-block" action="SearchTopic" method="Post" >
                        <div class="form-group">
                            <input type="search" class="form-control" name="name" placeholder="Search topic by name">
                        </div>
                    </form>
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">View topic</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <s:iterator var="l" value="list">
                                            <tr>
                                                <td><s:property value="#l.idTopic"></s:property></td>
                                                <td><s:property value="#l.nameTopic"></s:property></td>
                                                <td><a href="updateTopic?id=<s:property value="#l.idTopic"/>"><img src="img/edit (2).png"></a></td>
                                                <td><a href="deleteTopic?id=<s:property value="#l.idTopic"/>"><img src="img/trash.png"></a></td>
                                                <td><a href="viewDetailTopic?id=<s:property value="#l.idTopic"/>"><img src="img/view (1).png"></a></td>
                                            </tr>
                                        </s:iterator>                  
                                    </tbody>
                                </table>
