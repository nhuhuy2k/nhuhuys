<%-- 
    Document   : AddTopic
    Created on : 17-May-2020, 20:50:00
        ...
        <jsp:useBean id="MrTopic" class="model.dataProcess">
            <div class="container-scroller">
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <s:form action="addTopic.mamtom" method="Post" >
                        <ul class="form-style-1">
                            <li>
                                <label>ID topic <span class="required">*</span></label>
                                <input type="text" name="id" class="field-long" />
                            </li>
                            <li>
                                <label>Name topic <span class="required">*</span></label>
