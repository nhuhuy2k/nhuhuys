<%-- 
    Document   : listTrainee
    Created on : 23-May-2020, 00:23:03
...
<html lang="en">
    <head>
        ...
        <title>Manage Training System</title>
        <!-- plugins:css -->
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center">
                    ...
                    <form class="ml-auto search-form d-none d-md-block" action="ViewTraineeOfClass" method="Post" >
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <s:iterator var="l" value="list">
                                            <tr>
                                                <td><s:property value="#l.idTrainee"></s:property></td>
                                                <td><s:property value="#l.nameTrainee"></s:property></td>
                                                <td><s:property value="#l.phone"></s:property></td>
                                                <td><a href="updateTrainee?id=<s:property value="#l.idTrainee"/>"><img src="img/edit (2).png"></a></td>
                                                <td><a href="deleteTrainee?id=<s:property value="#l.idTrainee"/>"><img src="img/trash.png"></a></td>
                                                <td><a href="viewDetailTrainee?id=<s:property value="#l.idTrainee"/>"><img src="img/view (1).png"></a></td>
                                            </tr>
                                        </s:iterator>                  
                                    </tbody>
                                </table>
