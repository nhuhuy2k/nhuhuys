 <%-- 
    ...
    Created on : 25-May-2020, 08:24:09
...
<html lang="en">
    ...
    <body>
        <jsp:useBean id="MrTopic" class="model.TraineeProcess">
            <div class="container-scroller">
                            ...
                            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                    <div class="dropdown-header text-center">
                                        ...
                                        <p class="mb-1 mt-3 font-weight-semibold"><s:property value="%{#session.Admin}"/></p>
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <form id="prospects_form" action="AssignTraineeForm" method="Post"  >
                        <ul class="form-style-1">
                            Assign trainee to <s:text name="id"></s:text>
                                <li>
                                    <label>ID course <span class="required">*</span></label>
                                <s:textfield name="id" readonly="true"></s:textfield>

                                </li>

                                <li>
                                    <label>Trainee <span class="required">*</span></label>
                                    <input type="text" list="browsers" name="idT" id="browser" class="field-long">

                                    <datalist id="browsers">
                                        
                                        <c:forEach var="t" items="${MrTopic.trainee}">

                                            <option value="${t.idTrainee}">${t.nameTrainee}</option>
                        ...
                        <tbody>
                            <s:iterator value="list">
                                <tr>
                                    ...
                                    <td><s:property value="idC"></s:property></td>
                                    <td><a href="delete?id=<s:property value="id"/>" onclick="ConfirmDelete()"><img src="img/trash.png"></a></td>
