<%-- 
    ...
    Created on : 19-May-2020, 21:12:04
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center">
                    ...
                    <form class="ml-auto search-form d-none d-md-block" action="SearchTrainer" method="Post" >
                        <div class="form-group">
                            <input type="search" class="form-control" name="name" placeholder="Search trainer">
                        </div>
                    </form>
            ...
            <div class="container-fluid page-body-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="view">View topic</a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="main-panel">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">List Trainer</h1>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <s:iterator var="l" value="list">
                                            <tr>
                                                <td><s:property value="#l.idTrainer"></s:property></td>
                                                <td><s:property value="#l.nameTrainer"></s:property></td>
                                                <td><s:property value="#l.phone"></s:property></td>
                                                <td><a href="updateTrainer?id=<s:property value="#l.idTrainer"/>"><img src="img/edit (2).png"></a></td>
                                                <td><a href="deleteTrainer?id=<s:property value="#l.idTrainer"/>"><img src="img/trash.png"></a></td>
                                                <td><a href="viewDetailTrainer?id=<s:property value="#l.idTrainer"/>"><img src="img/view (1).png"></td>
                                                        </tr>
                                                    </s:iterator>                  
                                                    </tbody>
                                                    </table>
