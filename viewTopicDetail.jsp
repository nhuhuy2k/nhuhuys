<%-- 
    Document   : viewTopicDetail
    Created on : 18-May-2020, 10:50:55
...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper">
            <s:form action="viewDetailTopic" method="POST">
                <h1>Details topic</h1>
                ...
                <details>
                    ...
                    <table>
                        <tr>
                            <th scope="row">ID topic</th>
                            <td>${t.idTopic}</td>
                        </tr>
                        <tr>
                            <th scope="row">Name topic</th>
                            <td>${t.nameTopic}</td>
                        </tr>
                        <tr>
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="updateTopic?id=${t.idTopic}">Edit</a></li>
                        <li><a href="DeleteTopic?id=${t.idTopic}">Delete</a></li>
                        <li><a href="viewTopic">Back to list topic</a></li>
                    </ul>
                </details>
            </s:form>
        </div>
