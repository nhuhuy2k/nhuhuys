<%-- 
    Document   : AddTrainer
    Created on : 19-May-2020, 21:28:00
        ...
        <jsp:useBean id="MrTopic" class="model.dataProcess">
            ...
            <div class="container-scroller">
                ...
                <div class="container-fluid page-body-wrapper">
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="ui-basic">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item">
                                            <a class="nav-link" href="viewTrainee">View trainee</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <s:form action="addTrainer.mamtom" method="Post" >
                        <ul class="form-style-1">
                            <li>
                                <label>ID trainer:<span class="required">*</span></label>
                            ...
                            <li>
                                ...
                                <input type="email" name="gmail" class="field-long" place-holder="abc@gmail.com"/>
                            </li>
                            <li>
                            ...
                            <li>
                                <label for="job">Account:</label>

                                <select id="job" class="field-select" name="idAcc">
                                    <c:forEach var="t" items="${MrTopic.acc}">
                                        <option value="${t.idAcc}">${t.un}</option>
                                    </c:forEach>
                                </select>
                            </li>
                            <li>
