<%-- 
    Document   : viewCategoryDetail
    Created on : 19-May-2020, 15:36:51
...
a {
  ...
  text-decoration: none;
    ...
    <body>
        ...
        <div id="page-wrapper">
            <s:form action="viewDetailCategory" method="POST">
            ...
            <details>
                ...
                <ul>
                    <li><a href="updateCategory?id=${c.idCategory}">Edit</a></li>
                    <li><a href="deleteCategory?id=${c.idCategory}">Delete</a></li>
                </ul>
            </details>
            </s:form>
        </div>
