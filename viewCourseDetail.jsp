<%-- 
    ...
    Created on : 11-Jun-2020, 14:58:35
        ...
        <div id="page-wrapper">
            <s:form action="viewDetail" method="POST">
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="update?id=${c.id}">Edit</a></li>
                        <li><a href="delete?id=${c.id}">Delete</a></li>
                        <li><a href="AssignTrainee?id=${c.id}">List Trainee in course</a></li>
                        <li><a href="view">Back to list course</a></li>
