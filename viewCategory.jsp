<%-- 
    ...
    Created on : 19-May-2020, 14:54:23
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center">
                    ...
                    <form class="ml-auto search-form d-none d-md-block" action="SearchCategory" method="Post" >
                        <div class="form-group">
                            <input type="search" class="form-control" name="name" placeholder="Search category">
                        </div>
                    </form>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <s:iterator var="l" value="list">
                                            <tr>
                                                <td><s:property value="#l.idCategory"></s:property></td>
                                                <td><s:property value="#l.nameCategory"></s:property></td>
                                                <td><a href="updateCategory?id=<s:property value="#l.idCategory"/>"><img src="img/edit (2).png"></a></td>
                                                <td><a href="deleteCategory?id=<s:property value="#l.idCategory"/>"><img src="img/trash.png"></a></td>
                                                <td><a href="viewDetailCategory?id=<s:property value="#l.idCategory"/>"><img src="img/view (1).png"></td>
                                                        </tr>
                                                    </s:iterator>                  
                                                    </tbody>
                                                    </table>
