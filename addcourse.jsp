<%-- 
    Document   : addcourse
    Created on : 11-May-2020, 15:51:13
        ...
        <jsp:useBean id="MrTopic" class="model.dataProcess">
            <div class="container-scroller">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                    ...
                                    <a class="dropdown-item">Messages<i class="dropdown-item-icon tidmin-comment-alt"></i></a>
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <s:form action="add.nuocmam" method="Post" >
                        <ul class="form-style-1">
                            
                            <li>
                                <label>ID course <span class="required">*</span></label>
                                <input type="text" name="id" class="field-long" />
                            </li>
                            <li>
                                <label>Name course <span class="required">*</span></label>
                                <input type="text" name="name" class="field-long" />
                            </li>
                            <li>
                                <label>Location</label>
                                <select name="sllocation" class="field-select">
                            ...
                            <li>
                                <label>Status</label>
                                <select name="slsttus" class="field-select">
                                    <option value="Finish">Finish</option>
                                    <option value="Learning">Learning</option>
                                    <option value="Regist">Registing</option>
                                </select>
                            </li>
                            <li>
                                <label for="job">Topic</label>

                                <select id="job" class="field-select" name="sltopic">
                                    <c:forEach var="t" items="${MrTopic.topic}">
                                        <option value="${t.idTopic}">${t.nameTopic}-${t.idTrainer}</option>
                                    </c:forEach>
                                </select>
                            </li>
                            <li>
                                ...
                                <select id="job" class="field-select" name="slcategory">
                            ...
                            <li>
                                <label>Fees (VND): <span class="required">*</span></label>
                                <input type="text" name="fee" class="field-long"/>
                            </li>
                            <li>
                                <label>Start date <span class="required">*</span></label>
                                <input type="date" name="start" class="field-long"/>
                            </li>
                            <li>
                                <label>End date <span class="required">*</span></label>
                                <input type="date" name="end" class="field-long"/>
                            </li>
                            <li>
                                <label>Description <span class="required">*</span></label>
                                <textarea name="des" id="field5" class="field-long field-textarea"></textarea>
                            </li>
                            <li>
